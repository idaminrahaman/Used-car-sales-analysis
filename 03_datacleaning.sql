-----------------------------------------------------------
-- CLEAN & STANDARDIZE NUMERIC COLUMNS
-----------------------------------------------------------

-- Clean and standardize resale_price column
...
-- Normalize registered_year column
UPDATE sales_analysis
...
UPDATE sales_analysis
SET engine_capacity_cc = REPLACE(engine_capacity_cc, 'cc', '');

UPDATE sales_analysis
SET engine_capacity_cc = TRIM(engine_capacity_cc);

UPDATE sales_analysis
SET engine_capacity_cc = NULL
WHERE engine_capacity_cc = '';
...
UPDATE sales_analysis
SET kms_driven = REPLACE(kms_driven, 'Kms', '');

UPDATE sales_analysis
SET kms_driven = REPLACE(kms_driven, ',', '');

UPDATE sales_analysis
SET kms_driven = TRIM(kms_driven);
...
UPDATE sales_analysis
SET mileage = REPLACE(mileage, 'kmpl', '');

UPDATE sales_analysis
SET mileage = REPLACE(mileage, 'km/kg', '');
...
UPDATE sales_analysis
SET brand_name = SUBSTRING_INDEX(SUBSTRING_INDEX(model_name, ' ', 2), ' ', -1),
...
-----------------------------------------------------------
UPDATE sales_analysis SET brand_name = NULL WHERE brand_name = '';
UPDATE sales_analysis SET variant_name = NULL WHERE variant_name = '';
UPDATE sales_analysis SET transmission_type = NULL WHERE transmission_type = '';
UPDATE sales_analysis SET owner_type = NULL WHERE owner_type = '';
UPDATE sales_analysis SET fuel_type = NULL WHERE fuel_type = '';
UPDATE sales_analysis SET body_type = NULL WHERE body_type = '';
UPDATE sales_analysis SET city = NULL WHERE city = '';


-----------------------------------------------------------
-- INSURANCE COLUMN CLEANUP
-----------------------------------------------------------
-- Convert 1, 2, and blanks to NULL
UPDATE sales_analysis
SET insurance = NULL
...
-----------------------------------------------------------
-- VALIDATION QUERIES (COUNT NULL VALUES)
-----------------------------------------------------------
SELECT 
    COUNT(*) AS total_rows,
